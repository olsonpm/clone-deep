...
const originalTypeToCreateClone = getOriginalTypeToCreateClone(),
  setOfCloneableRawTypes = new Set(['object', 'function']),
  setOfTypesUnableToBeCloned = new Set(['Error', 'function', 'Promise'])
...
module.exports = rootOriginal => {
  ...
  function recursiveCloneDeep(original) {
    ...
    if (original !== null && !setOfCloneableRawTypes.has(originalRawType)) {
      return original
    }
